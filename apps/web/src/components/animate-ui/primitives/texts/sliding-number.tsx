...
function SlidingNumber({
  ...
  // Defaulted like `prevIntStrRaw` below it, which the upstream file already
  // does: this project's tsconfig checks indexed access, and a destructured
  // element is `string | undefined` without it.
